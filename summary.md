...
results/
  ...
  A7c_unbottlenecked.json         A7c un-bottlenecked DANN on 4096-d substrate (3 archs × 3 seeds, 1.70 min); D3 4096/2048/1024 best_devel=0.0832 memo gap +0.914 → fail-fast → a7c_dead_memorisation_dead (M14)
