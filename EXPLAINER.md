...
- **A5.5 cross-speaker splicing on A2.5 canonical anchor** — three-dimensional gate (UAR floor, speaker probe drop ≥ 1σ, splice-detector ≤ 0.55 UAR). In progress; Phase 1 (splice primitives) committed (smoke test 77% success rate, all unvoiced fallback); Phase 2 (augmented pooled cache build, ~90-135 min GPU) pending now that canonical A2.5 is locked.
