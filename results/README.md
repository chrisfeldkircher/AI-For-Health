...
- **Historical val-to-test gap = -0.003.** This is a same-partition diagnostic only. A later independent audit found 201/210 Development-local proxy groups crossing the canonical boundary, so the old devel_val/devel_test split is not established speaker-disjoint.
